...
<div class="modal fade" id="modedit">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <input type="hidden" name="id_kategorigallery"  class="form-control" value="<?php echo $r->id_kategorigallery; ?>">
         <div class="modal-body">
            <div class="form-group">
               <label for="">Nama Kategori Gallery</label>
               <input type="text" name="nama_kategorigallery"  class="form-control" value="<?php echo $r->nama_kategorigallery; ?>">
            </div>
         </div>
