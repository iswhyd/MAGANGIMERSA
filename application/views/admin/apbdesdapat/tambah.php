   ...
   <div class="modal-dialog">
      <div class="modal-content">
      	<div class="modal-header bg-success">
				<h4>Tambah APBD Pendapatan</h4>
      	</div>
      	<form action="<?php echo base_url('apbdesdapat/tambah') ?>" method="post">
      		...
      		<div class="form-group">
               ...
               <select class="form-control" name="kdjenisdapat">
                  ...
                  <?php foreach($jenisdapat->result() as $aga){ ?>
                     <option value="<?php echo $aga->kd_jenisdapat; ?>"><?php echo $aga->nama_jenisdapat; ?></option>
                  <?php } ?>
               </select>
            </div>
            <div class="form-group">
