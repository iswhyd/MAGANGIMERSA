<?php foreach($pendidikanpenduduk->result() as $r); ?>
<div class="modal fade" id="modedit">
   <div class="modal-dialog">
      <div class="modal-content">
      	<div class="modal-header bg-success">
				<h4>Edit Statistik Pendidikan</h4>
      	</div>
      	<form action="<?php echo base_url('pendidikanpenduduk/edit') ?>" method="post">
            ...
            <div class="form-group">
               ...
               <select class="form-control" name="kdpendidikan">
                  ...
                  <?php foreach($pendidikan->result() as $aga){ ?>
                     <option <?php if($aga->kd_pendidikan==$r->kdpendidikan){ echo 'selected'; } ?> value="<?php echo $aga->kd_pendidikan; ?>"><?php echo $aga->nama_pendidikan; ?></option>
                  <?php } ?>
               </select>
